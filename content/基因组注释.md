---
{"publish":true,"created":"2025-12-23T21:22:24.906+08:00","modified":"2025-12-24T22:05:10.578+08:00","cssclasses":""}
---
...
> [!NOTE]
> 计算机存储的基因组是一个**绝对坐标系**，永远从左向右增大（Index $1 \to N$）。然而，DNA 双链具有反向平行的性质，导致“上游（Upstream）”的定义随链而异：
> - **正链（+）**：$5' \to 3'$ 方向与坐标轴一致。上游意味着**减小**坐标值。
> - **负链（-）**：$5' \to 3'$ 方向与坐标轴相反。上游意味着**增大**坐标值。
> 如果不处理这个问题，直接对负链基因做减法，实际上提取的是其 3' 端尾部之后的序列，这在生物学上是完全错误的。
...
以下甘特图展示了过去二十年间，关键技术突破与基因组版本迭代的时序关系：
