---
{"publish":true,"created":"2025-05-03T22:16:23.000+08:00","modified":"2026-01-04T13:11:17.047+08:00","cssclasses":""}
---
...
> [!NOTE] renv cheatsheet
> | 命令                   | 说明    | 备注                      |
> | -------------------- | ----- | ----------------------- |
> | `renv::init()`       | 初始化项目 | 会自动创建基础设施并生成初始 lockfile |
> | `renv::status()`     | 检查状态  | 查看当前库与 lockfile 是否同步    |
> | `renv::activate()`   | 激活环境  | 加载 `.Rprofile`，切换到项目库   |
> | `renv::deactivate()` | 取消激活  | 恢复使用 R 全局库，但保留项目文件      |
> 
